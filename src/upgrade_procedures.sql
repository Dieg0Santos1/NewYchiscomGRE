-- SCRIPT DE ACTUALIZACIÓN (UPGRADE)
-- Duplica las filas devueltas tanto en procedimientos como en vistas para Crystal Reports

-- 1. MODIFICAR PROCEDIMIENTOS ALMACENADOS
GO
...
-- 2. MODIFICAR VISTAS DIRECTAS (Por si Crystal Reports vincula la vista en vez del procedimiento)
